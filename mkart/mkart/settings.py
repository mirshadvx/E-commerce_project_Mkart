...
TEMPLATES = [
    {
        ...
        "DIRS": [BASE_DIR / "Admin" / "templates", "templates"],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("POSTGRES_DB", "mkart"),
        "USER": os.environ.get("POSTGRES_USER", "postgres"),
        "PASSWORD": os.environ.get("POSTGRES_PASSWORD", "mnbmnb"),
...
LOGGING = {
    ...
    "handlers": {
        "file_registration_errors": {
            ...
            "filename": "registration_errors.log",
        },
    },
    "loggers": {
        "registration": {
